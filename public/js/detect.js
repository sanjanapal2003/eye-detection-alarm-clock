...
const REQUIRED_OPEN_TIME = 3000; // 3 seconds// about 1 second at ~30 FPS
...
function detectFace() {
    ...
    if (results.faceLandmarks.length > 0) {
        ...
        // document.getElementById("earValue").innerText =
        //     "EAR: " + ear.toFixed(3);
...
if (ear > THRESHOLD) {
    ...
    console.log("Eyes Open:", (openTime / 1000).toFixed(1), "seconds");
